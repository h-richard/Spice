...
import Spice.util.TypeResolver;
...
import static Spice.XMod_ExceptionLiteral.*;
 ...
 * </p>
 * <ul>
 *   <li>{@link Spice.impl.XMod_OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link Spice.impl.XMod_OperationImpl#getObjectTag <em>Object Tag</em>}</li>
 *   <li>{@link Spice.impl.XMod_OperationImpl#getParametersTag <em>Parameters Tag</em>}</li>
 *   <li>{@link Spice.impl.XMod_OperationImpl#getReturnTag <em>Return Tag</em>}</li>
 *   <li>{@link Spice.impl.XMod_OperationImpl#getExceptions <em>Exceptions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XMod_OperationImpl extends MinimalEObjectImpl.Container implements XMod_Operation {
    ...
    protected EClass eStaticClass() {
		return SpicePackage.Literals.XMOD_OPERATION;
	}
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpicePackage.XMOD_OPERATION__NAME, oldName, name));
	}
    ...
    public void setObjectTag(String newObjectTag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpicePackage.XMOD_OPERATION__OBJECT_TAG, oldObjectTag, objectTag));
	}
    ...
    public EList<String> getParametersTag() {
		if (parametersTag == null) {
			parametersTag = new EDataTypeUniqueEList<String>(String.class, this, SpicePackage.XMOD_OPERATION__PARAMETERS_TAG);
		}
    ...
    public void setReturnTag(String newReturnTag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpicePackage.XMOD_OPERATION__RETURN_TAG, oldReturnTag, returnTag));
	}
	...
	public EList<XMod_Exception> getExceptions() {
		if (exceptions == null) {
			exceptions = new EObjectContainmentEList<XMod_Exception>(XMod_Exception.class, this, SpicePackage.XMOD_OPERATION__EXCEPTIONS);
		}
		return exceptions;
	}
    ...
    public XMod_Exception callOperation() {
        ...
        if (getObjectTag() != null) { // check if the object on which the operation is being called has an annotation
        	...
        	try {
        		...
        		Spice.util.SpiceUtils.getExtMap().put(ExceptionContext.CONTEXT_KEY, 
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpicePackage.XMOD_OPERATION__EXCEPTIONS:
	...
	private static Object getDeepTarget(Object target, String params) throws ObjectNotFoundException, MethodNotFoundException, ParametersNotMatchingException, InvocationTargetException, IllegalAccessException, NoSuchMethodException {
		...
		if (current.contains("[")) {
			...
			for (Object obj : list) {
				...
				else if (obj instanceof NamedElement e) {
					if (e.getName().equals(subpropertyName)) target = e;
				}
			}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SpicePackage.XMOD_OPERATION__NAME:
				return getName();
			case SpicePackage.XMOD_OPERATION__OBJECT_TAG:
				return getObjectTag();
			case SpicePackage.XMOD_OPERATION__PARAMETERS_TAG:
				return getParametersTag();
			case SpicePackage.XMOD_OPERATION__RETURN_TAG:
				return getReturnTag();
			case SpicePackage.XMOD_OPERATION__EXCEPTIONS:
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SpicePackage.XMOD_OPERATION___CALL_OPERATION:
